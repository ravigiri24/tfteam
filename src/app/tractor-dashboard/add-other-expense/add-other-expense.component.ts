...
@Component({
  selector: 'app-add-other-expense',
  templateUrl: './add-other-expense.component.html',
  styleUrls: ['./add-other-expense.component.scss'],
})
export class AddOtherExpenseComponent  implements OnInit {
  constructor(
  ...
  getExpense() {
    ...
    let obj: any = this.share.getListObj('other_expenses', false, [], true);
