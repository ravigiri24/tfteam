...
import { AddOtherExpenseComponent } from '../add-other-expense/add-other-expense.component';
@Component({
  selector: 'app-other-expense-list',
  templateUrl: './other-expense-list.component.html',
  styleUrls: ['./other-expense-list.component.scss'],
})
export class OtherExpenseListComponent  implements OnInit {
  ...
  async showModal(dataUpdate: any = null) {
    const modal = await this.modalCtrl.create({
      component: AddOtherExpenseComponent,
      componentProps: {
