...
@Component({
  selector: 'app-view-maintainance-cost',
  templateUrl: './view-maintainance-cost.component.html',
  styleUrls: ['./view-maintainance-cost.component.scss'],
})
export class ViewMaintainanceCostComponent  implements OnInit {
  constructor(
...
const formattedDate = today.toISOString().split('T')[0];
   console.log("today",today);
    ...
    this.form = this.formBuilder.group({
      startDate: new FormControl(new Date("2020-01-01"), [Validators.required]),
      ...
      if (
        ...
        this.api.postapi('getTractorSheetByDate', obj).subscribe(
          (res: any) => {
            ...
            this.tractorArray=  this.tractorArray?.filter((f:any)=>f.reduceItemTotalAmount>0)
