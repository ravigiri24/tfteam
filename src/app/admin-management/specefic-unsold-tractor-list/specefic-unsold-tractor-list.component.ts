...
@Component({
  selector: 'app-specefic-unsold-tractor-list',
  templateUrl: './specefic-unsold-tractor-list.component.html',
...
export class SpeceficUnsoldTractorListComponent  implements OnInit {
  ...
  generateExcel() {
    ...
    const element = document.getElementById('unsold-sheet-report_specific');
