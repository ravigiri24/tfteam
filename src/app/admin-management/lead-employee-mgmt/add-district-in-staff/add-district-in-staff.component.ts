...
@Component({
  selector: 'app-add-district-in-staff',
  templateUrl: './add-district-in-staff.component.html',
  styleUrls: ['./add-district-in-staff.component.scss'],
})
export class AddDistrictInStaffComponent implements OnInit {
  constructor(
