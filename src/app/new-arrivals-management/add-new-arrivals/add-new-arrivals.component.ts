...
export class AddNewArrivalsComponent implements OnInit {
  ...
  getDataByRowCode(rowCode: any) {
    let obj = this.share.getDataRowObj('tractor', true, [], rowCode);
...
setModelDetailEvent(data: any){
  ...
  setModelDetail(data: any) {
    ...
    let dimensionandwieght = this.modelForm.controls[
      'dimensionandwieght'
    ] as FormGroup;
  ...
  initialize() {
    ...
    this.modelForm = this.fb.group({
      ...
      tractor_status: new FormControl(
        this.data?.tractor_status || this.tractor_status,
        [Validators.required]
      ),
      ...
      maintainanceEstimationCost: new FormControl(
        this.data?.maintainanceEstimationCost || null
      ),
      ...
      isInventoryStock: new FormControl(
        this.data?.isInventoryStock || this.isInventoryStock
      ),
      inventoryStoreId: new FormControl(
        this.data?.inventoryStoreId || this.inventoryStoreId
      ),
      ...
      purchasedetail: this.fb.group({
        ...
        address: new FormControl(this.data?.purchasedetail?.address || null),
        //city: new FormControl(this.data?.purchasedetail?.city || null),
        purchasePrice: new FormControl(
          this.data?.purchasedetail?.purchasePrice || null
        ),
        contact1: new FormControl(this.data?.purchasedetail?.contact1 || null),
        contact2: new FormControl(this.data?.purchasedetail?.contact2 || null),
        ...
        bankNameAuction: new FormControl(
          this.data?.purchasedetail?.bankNameAuction || null
        ),
        parkLocation: new FormControl(
          this.data?.purchasedetail?.parkLocation || null
        ),
        expectedDateOfArrival: new FormControl(
          this.data?.purchasedetail?.expectedDateOfArrival || null
        ),
        amountTransferDate: new FormControl(
          this.data?.purchasedetail?.amountTransferDate || null
        ),
      }),
