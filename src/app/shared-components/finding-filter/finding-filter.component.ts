...
@Component({
  selector: 'app-finding-filter',
  templateUrl: './finding-filter.component.html',
  styleUrls: ['./finding-filter.component.scss'],
})
export class FindingFilterComponent  implements OnInit {
