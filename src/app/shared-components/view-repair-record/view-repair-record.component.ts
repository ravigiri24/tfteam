...
@Component({
  selector: 'app-view-repair-record',
  templateUrl: './view-repair-record.component.html',
  styleUrls: ['./view-repair-record.component.scss'],
})
export class ViewRepairRecordComponent  implements OnInit {
  ...
  addNewJob(job_id: any) {
    ...
    this.api.postapi('updateOpp', obj).subscribe((res: any) => {
      ...
      async refurbishDetails(job:any){
                      const modal = await this.modalCtrl.create({
                        component: ViewMaintainanceExpenseComponent,
