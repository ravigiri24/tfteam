...
@Component({
  selector: 'app-finance-report-details',
  templateUrl: './finance-report-details.component.html',
  styleUrls: ['./finance-report-details.component.scss'],
})
export class FinanceReportDetailsComponent  implements OnInit {
...
this.resetValue()
 ...
 this.selectedPeriod={startDate:this.form.value.startDate,endDate:this.form.value.endDate}
   ...
   //this.selectedPeriod.startDate='2025-04-01'
        ...
        this.api.postapi('getFinanceTractorList', obj).subscribe(
          (res: any) => {
